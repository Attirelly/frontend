...
export default function OurNumbers() {
  ...
  return (
    ...
    > 
    {/* Section 4 */}
      <div className="w-full h-[792px] grid grid-cols-[1fr_3fr] bg-[#F7F9FC]">
      <span className="text-[32px] text-[#1B1C57] w-[326px] h-[88px] pl-[40px] mt-10" style={{fontWeight:800}}>Benefits worth 
₹35000+</span>
      <div className="relative">
         <div className="absolute top-0 -translate-y-1/8 shadow flex flex-col text-center w-[484px] h-[262px] py-[62px] px-[36px] bg-white rounded-2xl">
         <Image
         src="/CollegeAmbassador/person_over_hand.svg"
         alt="Person over hand"
         width={152}
         height={102}
         className="absolute top-0 left-40 -translate-y-1/2"/>
         ...
         <div className="absolute top-0 right-10 translate-y-3/4 shadow flex flex-col text-center w-[484px] h-[262px] py-[62px] px-[36px] bg-white rounded-2xl">
              <Image
         src="/CollegeAmbassador/wallet.svg"
         alt="Person over hand"
         width={102}
         height={102}
         className="absolute top-0 left-50 -translate-y-1/2"/>
         ...
         <div className="absolute bottom-0 -translate-y-1/2 shadow flex flex-col text-center w-[484px] h-[262px] py-[62px] px-[36px] bg-white rounded-2xl">
              <Image
