        ...
        <p className="flex flex-col gap-4 ml-[40px] mt-[55px] md:ml-[60px] md:mt-[30px] lg:ml-[90px] lg:mt-0">
          ...
          >
            ...
            ${screenSize === 'xl' ? 'w-[585px]' : ''}
                text-white text-[14px] lg:text-[20px] mt-2`} style={{ fontWeight: 400 }}>Step into the booming fashion e-commerce industry and unlock your potential with earning potential of more than 25K</span>
          </div>
