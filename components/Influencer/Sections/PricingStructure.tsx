...
// src/components/Influencer/Sections/PricingStructure.tsx
...
const PricingStructure: React.FC<ComponentProps> = ({ onNext, isLastStep }) => {
  ...
  const { pricingStructure, updatePricingStructure } = useInfluencerStore(state => ({
    pricingStructure: state.pricingStructure,
    updatePricingStructure: state.updatePricingStructure,
  }));
