...
// const platformOptions = ['Instagram', 'Youtube', 'Facebook', 'Snapchat', 'Other'];
...
// const SocialPreference = forwardRef(({ onNext, isLastStep }: ComponentProps, ref) => {
...
//   const [categoryNiche, setCategoryNiche] = useState('');
...
//       instagram_url: `https://instagram.com/${instaHandle}`, // We construct the full URL here
...
//   const handleNext = () => {
//     if (!primaryPlatform || !instaHandle || !categoryNiche || !contentStyle) {
...
//           </label>
//           <select id="primary-platform" value={primaryPlatform} onChange={(e) => setPrimaryPlatform(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-md">
...
//                 <input type="url" id="facebook-url" value={facebookUrl} onChange={(e) => setFacebookUrl(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-md" placeholder="https://facebook.com/yourpage" />
//             </div>
//             <div>
//                 <label htmlFor="snapchat-url" className="block text-sm font-medium text-gray-700">Snapchat URL (Optional)</label>
//                 <input type="url" id="snapchat-url" value={snapchatUrl} onChange={(e) => setSnapchatUrl(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-md" placeholder="https://snapchat.com/add/yourusername" />
//             </div>
//         </div>
        
//         <div>
//             <label htmlFor="website-url" className="block text-sm font-medium text-gray-700">Website URL (Optional)</label>
//             <input type="url" id="website-url" value={websiteUrl} onChange={(e) => setWebsiteUrl(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-md" placeholder="https://yourwebsite.com" />
//         </div>
...
//             </label>
//             <select id="category-niche" value={categoryNiche} onChange={(e) => setCategoryNiche(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-md">
...
//             </label>
//             <select id="content-style" value={contentStyle} onChange={(e) => setContentStyle(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-md">
...
// src/components/Influencer/Sections/SocialPreference.tsx
...
const SocialPreference: React.FC<ComponentProps> = ({ onNext, isLastStep }) => {
  ...
  const { socialPresence, updateSocialPresence } = useInfluencerStore(state => ({
    socialPresence: state.socialPresence,
    updateSocialPresence: state.updateSocialPresence,
  }));
