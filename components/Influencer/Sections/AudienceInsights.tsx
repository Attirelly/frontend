...
// src/components/Influencer/Sections/AudienceInsights.tsx
...
const AudienceInsights: React.FC<ComponentProps> = ({ onNext, isLastStep }) => {
  ...
  const { audienceInsights, updateAudienceInsights } = useInfluencerStore(state => ({
    audienceInsights: state.audienceInsights,
    updateAudienceInsights: state.updateAudienceInsights,
  }));
