...
interface InfluencerSidebarProps {
  activeSectionId: InfluencerSectionKey; // Use the specific type for better safety
  onSectionClick: (id: InfluencerSectionKey) => void;
}

// ✨ CORRECTED: The 'id' for each section now matches the camelCase keys in your Zustand store.
const sections: { id: InfluencerSectionKey; title: string; desc: string; iconUrl: string }[] = [
  { id: 'basicInformation', title: 'Basic Information', desc: 'Your personal and contact details.', iconUrl: '/OnboardingSections/business_details.png' },
  { id: 'socialPresence', title: 'Social Presence', desc: 'Your platforms, niche, and style.', iconUrl: '/OnboardingSections/social_links.png' },
  { id: 'audienceInsights', title: 'Audience Insights', desc: 'Demographics and engagement data.', iconUrl: '/OnboardingSections/instagram.svg' },
  { id: 'collaborationPreferences', title: 'Collaboration Preferences', desc: 'The types of collabs you prefer.', iconUrl: '/OnboardingSections/instagram.svg' },
  { id: 'pricingStructure', title: 'Pricing Structure', desc: 'Your rates for different content.', iconUrl: '/OnboardingSections/price_filters.png' },
  { id: 'pastWork', title: 'Past Work', desc: 'Showcase your experience.', iconUrl: '/OnboardingSections/instagram.svg' },
  { id: 'locationAndAvailability', title: 'Location & Availability', desc: 'Where you are and your availability.', iconUrl: '/OnboardingSections/where_to_sell.png' },
  { id: 'mediaKit', title: 'Media Kit', desc: 'Upload your profile photos.', iconUrl: '/OnboardingSections/store_photos.png' },
];
...
// --- Sub-component for Desktop View (No changes needed in the JSX) ---
