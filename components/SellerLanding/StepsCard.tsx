...
export default function StepsCard({id, title, subtitle, image} : StepsCardProps){
  return(
<div className="relative flex flex-col items-center justify-center pt-[54px] pb-[90px] px-[28px] rounded-2xl shadow-lg  p-4 bg-white hover:shadow-xl transition duration-300">
      <Image
        src={image}
        alt={title}
        width={97}
