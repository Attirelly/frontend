// components/SectionThreeContainerSkeleton.tsx
'use client';
import { useEffect, useState } from "react";



export default function SectionThreeContainerSkeleton() {
    ...
    return (
        <div className="w-full mx-auto space-y-4 lg:space-y-8 animate-pulse">
            ...
            <div className="relative flex items-center">
                ...
                <div className="w-full grid grid-cols-2 gap-x-2 md:grid-cols-3 md:gap-x-10 lg:grid-cols-5 lg:gap-x-12">
