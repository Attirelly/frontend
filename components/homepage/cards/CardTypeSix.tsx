...
const CardTypeSix: React.FC<CardProps> = ({ imageUrl, title, description }) => {
  return (
    <div>
    <div
      className={`${manrope.className} relative w-[293px] h-[333px] rounded-2xl overflow-hidden`}
    >
      {/* Background Image */}
      ...
      <div className="flex flex-col items-center justify-center absolute bottom-0 left-1/2 transform -translate-x-1/2 z-20 pb-7 text-white mx-auto">
        ...
        <button
          className="w-[100px] h-[32px] text-sm bg-white text-black mt-4"
    ...
    <h3
        className="text-[20px] text-black font-extrabold whitespace-nowrap z-50 text-center mt-2"
        style={{ fontWeight: 500 }}
      >
        <div>{title}</div>
      </h3>
