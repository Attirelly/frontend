...
export default function SocialLinksComponent() {
    ...
    // return (
    //     <div className="space-y-6 rounded-md w-full max-w-3xl mx-auto p-4 sm:p-0 text-black placeholder-gray-400">
    ...
    //                         value={instagramUsname}
    //                         onChange={handleInstagramChange}
    //                         className="flex-1 px-3 py-2 outline-none text-xs sm:text-sm 
    //                         disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed"
    //                         disabled={isInstagramConnected}
    //                     />
    //                 </div>
    ...
    //         {/* Instagram Integration */}
    //         <div className="bg-white shadow-sm space-y-4 rounded-2xl p-4 sm:p-6 flex flex-col md:flex-row items-center justify-between text-center md:text-left">
    //             <div className="space-y-3 md:w-2/3">
