...
const Hero = () => {
  return (
    <section
      className="text-center py-24 px-4 sm:px-6 lg:px-8" // Increased vertical padding
      style={{
        background: 'linear-gradient(to bottom, #DDEBFF 90%, #F5F9FF 10%)', // Adjusted gradient
      }}
    >
      <div className="max-w-4xl mx-auto font-rosario">
        ...
        <div className="inline-flex items-center gap-3 border-gray-300 rounded-full px-7 py-3 text-3xl font-medium text-gray-800 my-8 shadow-sm">
