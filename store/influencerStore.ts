...
> = {
  ...
  audienceInsights: {
    followers: { instagram: 0, youtube: 0, facebook: 0 },
    engagementMetrics: {
      avgLikesPerReel: 0,
      avgCommentsPerReel: 0,
      avgViewsPerReel: 0,
      engagementRate: 0,
    },
    audienceGenderSplit: { male: 0, female: 0, other: 0 },
    topAgeGroups: [],
    topLocations: [],
    audienceType: null,
  },
...
export const useInfluencerStore = create<InfluencerOnboardingState>((set) => ({
  ...
  updateAudienceInsights: (data) =>
    set((state) => ({
      audienceInsights: {
        ...state.audienceInsights,
        ...data,
        followers: {
          ...state.audienceInsights.followers,
          ...data.followers,
        },
        engagementMetrics: {
          ...state.audienceInsights.engagementMetrics,
          ...data.engagementMetrics,
        },
        audienceGenderSplit: {
          ...state.audienceInsights.audienceGenderSplit,
          ...data.audienceGenderSplit,
        },
      },
    })),
  updateCollaborationPreferences: (data) =>
  ...
  updatePricingStructure: (data) =>
    set((state) => ({
      pricingStructure: {
        ...
        ...data,
        pricing: {
          ...state.pricingStructure.pricing,
          ...data.pricing,
        },
      },
    })),
